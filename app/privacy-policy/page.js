  ...
  return (
    <>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-accent mb-4">5. Cookies</h2>
          <p className="text-accent/80 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-accent mb-4">8. Children's Privacy</h2>
          <p className="text-accent/80 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-accent mb-4">9. Changes to This Privacy Policy</h2>
          <p className="text-accent/80 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-accent mb-4">10. Contact Us</h2>
          <p className="text-accent/80 mb-4">
