  ...
  return (
    <>
      ...
      <div className="mb-10 md:mb-12 lg:mb-16 animate-fade-in">
        ...
        <p className="text-lg sm:text-xl text-accent/80 max-w-3xl leading-relaxed">
      ...
      <div className="prose prose-lg max-w-none">
        <div className="grid sm:grid-cols-2 gap-6 mb-10 md:mb-12">
          <div className="bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-lg border border-secondary-300 hover-lift">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-accent mb-4">General Inquiries</h2>
            <p className="text-accent/80 mb-3 font-semibold">
              <span className="text-accent">Email:</span> info@stockmarketbullion.com
            </p>
          ...
          <div className="bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-lg border border-secondary-300 hover-lift">
            <div className="w-14 h-14 bg-secondary rounded-xl flex items-center justify-center mb-4 shadow-lg">
              <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-accent mb-4">Technical Support</h2>
            <p className="text-accent/80 mb-3 font-semibold">
              <span className="text-accent">Email:</span> support@stockmarketbullion.com
            </p>
            <p className="text-accent/70 leading-relaxed">
          ...
          <div className="bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-lg border border-secondary-300 hover-lift">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-accent mb-4">Privacy & Legal</h2>
            <p className="text-accent/80 mb-3 font-semibold">
              <span className="text-accent">Email:</span> privacy@stockmarketbullion.com
            </p>
            <p className="text-accent/70 leading-relaxed">
          ...
          <div className="bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-lg border border-secondary-300 hover-lift">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-accent mb-4">Business & Partnerships</h2>
            <p className="text-accent/80 mb-3 font-semibold">
              <span className="text-accent">Email:</span> business@stockmarketbullion.com
            </p>
            <p className="text-accent/70 leading-relaxed">
        ...
        <section className="mb-10 md:mb-12 bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-xl border border-secondary-300 animate-fade-in">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-accent mb-6">Response Time</h2>
        ...
        <section className="mb-10 md:mb-12 bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-xl border border-secondary-300 animate-fade-in">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-accent mb-6">Follow Us</h2>
          ...
          <div className="flex flex-wrap gap-4">
            <a href="#" className="px-4 py-2 bg-accent text-white rounded-xl font-semibold hover:shadow-lg hover-lift transition-all">Twitter</a>
            <a href="#" className="px-4 py-2 bg-accent text-white rounded-xl font-semibold hover:shadow-lg hover-lift transition-all">LinkedIn</a>
            <a href="#" className="px-4 py-2 bg-accent text-white rounded-xl font-semibold hover:shadow-lg hover-lift transition-all">Facebook</a>
          </div>
        </section>

        <section className="mb-10 md:mb-12 bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-xl border border-secondary-300 animate-fade-in">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-accent mb-6">Frequently Asked Questions</h2>
          <div className="space-y-6">
            <div className="p-4 bg-white/50 rounded-xl">
              <h3 className="text-lg md:text-xl font-bold text-accent mb-3">How often is the data updated?</h3>
            ...
            <div className="p-4 bg-white/50 rounded-xl">
              <h3 className="text-lg md:text-xl font-bold text-accent mb-3">Is the information provided financial advice?</h3>
              <p className="text-accent/80 leading-relaxed">
            ...
            <div className="p-4 bg-white/50 rounded-xl">
              <h3 className="text-lg md:text-xl font-bold text-accent mb-3">How can I report an error?</h3>
              <p className="text-accent/80 leading-relaxed">
