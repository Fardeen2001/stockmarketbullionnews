    ...
    <>
      ...
      <div className="prose prose-lg max-w-none">
        <section className="mb-10 md:mb-12 bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-xl border border-secondary-300 animate-fade-in">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-accent mb-6">Our Mission</h2>
        ...
        <section className="mb-10 md:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-accent mb-6 md:mb-8">What We Offer</h2>
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-lg border border-secondary-300 hover-lift">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-accent mb-3">Stock Market Data</h3>
            ...
            <div className="bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-lg border border-secondary-300 hover-lift">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-accent mb-3">Precious Metals</h3>
              <p className="text-accent/80 leading-relaxed">
            ...
            <div className="bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-lg border border-secondary-300 hover-lift">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-accent mb-3">Sharia-Compliant Stocks</h3>
              <p className="text-accent/80 leading-relaxed">
            ...
            <div className="bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-lg border border-secondary-300 hover-lift">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-accent mb-3">AI-Powered News</h3>
              <p className="text-accent/80 leading-relaxed">
        ...
        <section className="mb-10 md:mb-12 bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-xl border border-secondary-300 animate-fade-in">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-accent mb-6">Our Technology</h2>
          ...
          <ul className="space-y-4 text-accent/80">
            <li className="flex items-start gap-3">
              ...
              <span><strong className="text-accent">AI-Powered Content Generation:</strong> Our intelligent systems analyze market data and generate insightful articles</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-accent font-bold mt-1">•</span>
              <span><strong className="text-accent">Real-Time Data:</strong> Live updates from multiple financial data sources</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-accent font-bold mt-1">•</span>
              <span><strong className="text-accent">Vector Search:</strong> Advanced semantic search to find relevant content quickly</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-accent font-bold mt-1">•</span>
              <span><strong className="text-accent">Trend Detection:</strong> AI algorithms identify emerging market trends and opportunities</span>
            </li>
          </ul>
        </section>

        <section className="mb-10 md:mb-12 bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-xl border border-secondary-300 animate-fade-in">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-accent mb-6">Our Commitment</h2>
          <p className="text-accent/80 mb-6 text-lg leading-relaxed">
        ...
        <section className="mb-10 md:mb-12 bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-xl border-l-4 border-accent animate-fade-in">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-accent mb-6">Disclaimer</h2>
        ...
        <section className="mb-10 md:mb-12 bg-secondary/80 rounded-3xl p-6 md:p-8 shadow-xl border border-secondary-300 animate-fade-in">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-accent mb-6">Contact Us</h2>
          <p className="text-accent/80 text-lg leading-relaxed mb-4">
            We'd love to hear from you! If you have questions, suggestions, or feedback, please visit our 
            <a href="/contact" className="text-accent hover:text-accent-300 font-semibold underline decoration-2 underline-offset-2 ml-1 transition-colors">contact page</a>.
          </p>
        </section>
      </div>
    </div>
