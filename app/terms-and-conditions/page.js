  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold text-slate-100 mb-8">Terms and Conditions</h1>
        ...
        <div>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-300 mb-4">
              <strong className="text-emerald-400">Financial Disclaimer:</strong> The information provided on this website is for informational
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-slate-100 mb-4">9. Contact Information</h2>
            <p className="text-slate-300 mb-4">
              If you have any questions about these Terms and Conditions, please contact us at:
            </p>
            <p className="text-slate-300">
              <strong>Email:</strong> legal@stockmarketbullion.com<br />
              <strong>Website:</strong> <a href="/contact" className="text-emerald-400 hover:underline">Contact Page</a>
            </p>
          </section>
        </div>

        <div className="mt-12 pt-8 border-t border-slate-700 flex flex-wrap gap-4 justify-center">
          <a href="/privacy-policy" className="text-emerald-400 hover:underline font-medium">Privacy Policy</a>
