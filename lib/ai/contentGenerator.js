...
1. STRUCTURE - Use heading tags for SEO:
   - Use ## for main sections (h2): e.g., ## Market Overview, ## Key Drivers, ## Impact on Investors, ## Conclusion
   - Use ### for subsections (h3) where appropriate
   - Include 4-6 ## headings. Each ## must be on its own line followed by 2-3 paragraphs.

2. CONTENT:
   - Provides factual information with relevant data and statistics
   - Professional journalistic style focusing on Indian and global markets
   - Include primary and secondary keywords naturally in headings and body
   - Start with a compelling hook, then structured sections with ## headings

3. FORMAT:
   - Output ONLY the article body (no title). Use ## and ### for section headings.
   - Example: [intro paragraph] then ## Market Overview [2-3 paragraphs] then ## Key Analysis [content]
