        ...
        <div className="relative z-10 flex flex-col flex-grow">
          <div className="flex items-start justify-between mb-6">
            <div className="flex-1 min-w-0">
              <h3 className="text-xl md:text-2xl font-bold text-accent mb-2 group-hover:text-white transition-colors duration-300 truncate">
                {stock.name || stock.symbol}
              </h3>
              <p className="text-sm text-accent/70 group-hover:text-white/80 transition-colors duration-300">
            ...
            {stock.imageUrl ? (
              ...
              <div className="w-16 h-16 md:w-20 md:h-20 relative rounded-2xl bg-primary flex items-center justify-center shadow-lg transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 ml-4 flex-shrink-0">
          ...
          <div className="mt-auto">
            ...
            <div className="text-sm text-accent/70 group-hover:text-white/70 transition-colors duration-300 flex flex-wrap gap-2">
              {stock.sector && (
