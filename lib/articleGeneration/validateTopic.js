...
export async function validateTopic({ topic, relatedSymbols = [], relatedMetals = [], facts = [], factCount }) {
  ...
  // If we have related symbols or metals, validate they exist in DB
  ...
  // If topicKey is short (e.g. "PV", "IT") and not a known symbol/metal, reject
