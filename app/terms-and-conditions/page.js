...
export default function TermsAndConditionsPage() {
  ...
  return (
    <>
      ...
      <h1 className="text-4xl font-bold text-accent mb-8">Terms and Conditions</h1>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-accent mb-4">2. Use License</h2>
          <p className="text-accent/80 mb-4">
          ...
          <ul className="list-disc pl-6 text-accent/80 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-accent mb-4">3. Disclaimer</h2>
          <p className="text-accent/80 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-accent mb-4">4. Limitations</h2>
          <p className="text-accent/80 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-accent mb-4">5. Accuracy of Materials</h2>
          <p className="text-accent/80 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-accent mb-4">6. Links</h2>
          <p className="text-accent/80 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-accent mb-4">7. Modifications</h2>
          <p className="text-accent/80 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-accent mb-4">8. Governing Law</h2>
          <p className="text-accent/80 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-accent mb-4">9. Contact Information</h2>
          <p className="text-accent/80 mb-4">
            If you have any questions about these Terms and Conditions, please contact us at:
          </p>
          <p className="text-accent/80">
            <strong>Email:</strong> legal@stockmarketbullion.com<br />
            <strong>Website:</strong> <a href="/contact" className="text-accent hover:underline">Contact Page</a>
          </p>
        </section>
      </div>
    </div>
