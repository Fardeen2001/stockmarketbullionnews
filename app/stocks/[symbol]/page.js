  ...
  return (
    <>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex-1">
            ...
            <p className="text-base sm:text-lg text-gray-600 flex flex-wrap items-center gap-2">
              <span className="px-3 py-1 bg-indigo-100 text-indigo-700 rounded-lg font-semibold text-sm">
                {stock.symbol}
              </span>
      ...
      <div className="glass rounded-3xl shadow-xl p-6 md:p-8 mb-8 md:mb-10 border border-white/30 animate-fade-in">
        ...
        {/* Key Metrics */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-6 pt-6 border-t border-gray-200">
          <div className="p-4 bg-white/50 rounded-xl">
            <p className="text-xs md:text-sm text-gray-500 font-medium mb-1">Market Cap</p>
          ...
          <div className="p-4 bg-white/50 rounded-xl">
            <p className="text-xs md:text-sm text-gray-500 font-medium mb-1">P/E Ratio</p>
            <p className="text-lg md:text-xl font-bold text-gray-900">{stock.peRatio || 'N/A'}</p>
          </div>
          <div className="p-4 bg-white/50 rounded-xl">
            <p className="text-xs md:text-sm text-gray-500 font-medium mb-1">52W High</p>
            <p className="text-lg md:text-xl font-bold text-gray-900">
              ₹{stock.high52Week?.toLocaleString('en-IN', { minimumFractionDigits: 2 }) || 'N/A'}
            </p>
          </div>
          <div className="p-4 bg-white/50 rounded-xl">
            <p className="text-xs md:text-sm text-gray-500 font-medium mb-1">52W Low</p>
            <p className="text-lg md:text-xl font-bold text-gray-900">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-4 pt-4 border-t border-gray-200">
          <div className="p-4 bg-white/50 rounded-xl">
            <p className="text-xs md:text-sm text-gray-500 font-medium mb-1">Open</p>
          ...
          <div className="p-4 bg-white/50 rounded-xl">
            <p className="text-xs md:text-sm text-gray-500 font-medium mb-1">High</p>
            <p className="text-base md:text-lg font-bold text-gray-900">
              {stock.priceHistory && stock.priceHistory.length > 0
          ...
          <div className="p-4 bg-white/50 rounded-xl">
            <p className="text-xs md:text-sm text-gray-500 font-medium mb-1">Low</p>
            <p className="text-base md:text-lg font-bold text-gray-900">
              {stock.priceHistory && stock.priceHistory.length > 0
          ...
          <div className="p-4 bg-white/50 rounded-xl">
            <p className="text-xs md:text-sm text-gray-500 font-medium mb-1">Volume</p>
            <p className="text-base md:text-lg font-bold text-gray-900">
              {stock.volume 
      ...
      {stock.priceHistory && stock.priceHistory.length > 0 && (
        <div className="glass rounded-3xl shadow-xl p-6 md:p-8 mb-8 md:mb-10 border border-white/30 animate-fade-in">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Price Chart with Technical Indicators</h2>
      ...
      {stock.description && (
        <div className="glass rounded-3xl shadow-xl p-6 md:p-8 mb-8 md:mb-10 border border-white/30 animate-fade-in">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">About {stock.name || stock.symbol}</h2>
      ...
      <div className="mb-8 md:mb-10">
        ...
        {news.length > 0 ? (
          ...
          <div className="glass rounded-3xl p-8 text-center border border-white/30">
            <p className="text-gray-500 text-lg">No news available for this stock.</p>
          </div>
        )}
      </div>
