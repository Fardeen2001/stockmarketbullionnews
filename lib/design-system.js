...
export const designSystem = {
  ...
  shadows: {
    ...
    colored: {
      primary: '0 10px 15px -3px rgb(99 102 241 / 0.3), 0 4px 6px -4px rgb(99 102 241 / 0.3)',
...
export const getCardClasses = (variant = 'default') => {
  const base = 'glass rounded-3xl border border-white/30 shadow-lg hover:shadow-xl transition-all duration-300';
...
export const getGradientTextClasses = () => {
  return 'gradient-text bg-gradient-primary bg-clip-text text-transparent';
};
...
export const getButtonClasses = (variant = 'primary', size = 'md') => {
  ...
  const variants = {
    primary: `${base} bg-gradient-primary text-white shadow-lg shadow-indigo-500/50 hover:shadow-xl hover:shadow-indigo-500/50 hover-lift`,
    secondary: `${base} glass text-gray-700 hover:bg-gradient-primary hover:text-white border border-white/30`,
    outline: `${base} border-2 border-indigo-500 text-indigo-600 hover:bg-indigo-500 hover:text-white`,
    ghost: `${base} text-gray-700 hover:bg-white/50`,
  };
