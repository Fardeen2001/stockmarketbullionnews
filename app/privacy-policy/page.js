  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <nav className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-6 mb-12 animate-fade-in border border-slate-700" aria-label="Table of contents">
          <h2 className="text-lg font-semibold text-slate-100 mb-4">Contents</h2>
          <ol className="list-decimal list-inside space-y-2 text-slate-300 text-sm md:text-base">
            <li><a href="#introduction" className="text-emerald-400 hover:text-emerald-300 hover:underline">Introduction</a></li>
            <li><a href="#information-we-collect" className="text-emerald-400 hover:text-emerald-300 hover:underline">Information We Collect</a></li>
            <li><a href="#how-we-use" className="text-emerald-400 hover:text-emerald-300 hover:underline">How We Use Your Information</a></li>
            <li><a href="#legal-basis" className="text-emerald-400 hover:text-emerald-300 hover:underline">Legal Basis for Processing</a></li>
            <li><a href="#cookies" className="text-emerald-400 hover:text-emerald-300 hover:underline">Cookies and Tracking</a></li>
            <li><a href="#third-party" className="text-emerald-400 hover:text-emerald-300 hover:underline">Third-Party Services</a></li>
            <li><a href="#data-retention" className="text-emerald-400 hover:text-emerald-300 hover:underline">Data Retention</a></li>
            <li><a href="#data-security" className="text-emerald-400 hover:text-emerald-300 hover:underline">Data Security</a></li>
            <li><a href="#your-rights" className="text-emerald-400 hover:text-emerald-300 hover:underline">Your Rights</a></li>
            <li><a href="#international" className="text-emerald-400 hover:text-emerald-300 hover:underline">International Transfers</a></li>
            <li><a href="#children" className="text-emerald-400 hover:text-emerald-300 hover:underline">Children&apos;s Privacy</a></li>
            <li><a href="#changes" className="text-emerald-400 hover:text-emerald-300 hover:underline">Changes to This Policy</a></li>
            <li><a href="#contact" className="text-emerald-400 hover:text-emerald-300 hover:underline">Contact Us</a></li>
          </ol>
        </nav>
        ...
        <div className="space-y-12">
          ...
          <section id="information-we-collect" className="scroll-mt-24">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-medium text-slate-100 mb-2">Information You Provide</h3>
              ...
              <div>
                <h3 className="text-lg font-medium text-slate-100 mb-2">Information Collected Automatically</h3>
                <ul className="list-disc pl-6 text-slate-300 space-y-1">
              ...
              <div>
                <h3 className="text-lg font-medium text-slate-100 mb-2">Information from Cookies and Similar Technologies</h3>
          ...
          <section id="legal-basis" className="scroll-mt-24">
            <h2 className="text-2xl font-semibold text-slate-100 mb-4">4. Legal Basis for Processing</h2>
            <p className="text-slate-300 mb-4">
          ...
          <section id="cookies" className="scroll-mt-24">
            <h2 className="text-2xl font-semibold text-slate-100 mb-4">5. Cookies and Tracking</h2>
            <p className="text-slate-300 mb-4">
            ...
            <p className="text-slate-300 mb-4">
              ...
              <a href="https://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:underline">allaboutcookies.org</a>.
            </p>
          </section>
          ...
          <section id="third-party" className="scroll-mt-24">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><strong>Google AdSense:</strong> Serves ads and may use cookies to show relevant advertising and measure performance. You can manage ad personalization at{" "}
                <a href="https://adssettings.google.com" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:underline">Google Ad Settings</a>.
              </li>
          ...
          <section id="data-retention" className="scroll-mt-24">
            <h2 className="text-2xl font-semibold text-slate-100 mb-4">7. Data Retention</h2>
            <p className="text-slate-300 mb-4">
          ...
          <section id="data-security" className="scroll-mt-24">
            <h2 className="text-2xl font-semibold text-slate-100 mb-4">8. Data Security</h2>
            <p className="text-slate-300 mb-4">
          ...
          <section id="your-rights" className="scroll-mt-24">
            <h2 className="text-2xl font-semibold text-slate-100 mb-4">9. Your Rights</h2>
            <p className="text-slate-300 mb-4">
          ...
          <section id="international" className="scroll-mt-24">
            <h2 className="text-2xl font-semibold text-slate-100 mb-4">10. International Transfers</h2>
            <p className="text-slate-300">
          ...
          <section id="children" className="scroll-mt-24">
            <h2 className="text-2xl font-semibold text-slate-100 mb-4">11. Children&apos;s Privacy</h2>
            <p className="text-slate-300">
          ...
          <section id="changes" className="scroll-mt-24">
            <h2 className="text-2xl font-semibold text-slate-100 mb-4">12. Changes to This Policy</h2>
            <p className="text-slate-300 mb-4">
          ...
          <section id="contact" className="scroll-mt-24">
            <h2 className="text-2xl font-semibold text-slate-100 mb-4">13. Contact Us</h2>
            <p className="text-slate-300 mb-4">
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg p-6 border border-slate-700">
              <p className="text-slate-300 mb-2"><strong>Email:</strong> privacy@stockmarketbullion.com</p>
              <p className="text-slate-300 mb-2"><strong>Website:</strong> <a href="/contact" className="text-emerald-400 hover:underline">Contact Page</a></p>
        ...
        <div className="mt-12 pt-8 border-t border-slate-700 flex flex-wrap gap-4 justify-center">
          <a href="/terms-and-conditions" className="text-emerald-400 hover:underline font-medium">Terms &amp; Conditions</a>
          <span className="text-slate-600">|</span>
          <a href="/contact" className="text-emerald-400 hover:underline font-medium">Contact Us</a>
          <span className="text-slate-600">|</span>
          <a href="/" className="text-emerald-400 hover:underline font-medium">Home</a>
        </div>
      </div>
    </>
  );
