...
import { HUGGINGFACE_CONFIG, getEmbeddingInferenceConfig } from './config';

// Embedding generator using Hugging Face models
// Uses legacy api-inference.huggingface.co - router.huggingface.co often returns 404 for embeddings
export class EmbeddingGenerator {
  constructor(apiKey) {
    this.hf = new HfInference(apiKey, getEmbeddingInferenceConfig(apiKey));
    this.model = HUGGINGFACE_CONFIG.embeddingModel;
  }
